...
export default function LandingPage() {
  ...
  const stats = [
    { label: "Helper Rating Avg", value: "4.9★", icon: <Star className="text-amber-400" size={18} /> },
    { label: "Active Student Solvers", value: "1,200+", icon: <Users className="text-indigo-400" size={18} /> },
    { label: "Tasks Solved", value: "3,500+", icon: <BookOpen className="text-emerald-400" size={18} /> },
  ];
    ...
    <div className="space-y-24 py-6">
      ...
      <section className="relative text-center max-w-4xl mx-auto space-y-8 pt-10 overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 animate-fade-in-up delay-300">
          ...
          <Link 
            to="/browse"
            className="w-full sm:w-auto px-8 py-3.5 rounded-full bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-200 text-sm font-bold flex items-center justify-center space-x-2"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="glass p-8 rounded-3xl border border-slate-800 flex flex-col justify-between hover:border-slate-700/60 transition group hover-lift hover-shine animate-fade-in-left delay-200">
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-bold font-display group-hover:text-indigo-400 transition-colors">Post & Collaborate (Clients)</h3>
          ...
          <div className="glass p-8 rounded-3xl border border-slate-800 flex flex-col justify-between hover:border-slate-700/60 transition group hover-lift hover-shine animate-fade-in-right delay-300">
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-bold font-display group-hover:text-emerald-400 transition-colors">Collaborate & Teach (Helpers)</h3>
                <p className="text-xs text-slate-400 leading-relaxed">
