    ...
    <div className="max-w-5xl mx-auto py-4 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <section className="lg:col-span-2 space-y-6">
          ...
          {chatPartnerId && (
            <div id="workspace-chat-box" className="glass rounded-3xl border border-[#FFE5BF] overflow-hidden flex flex-col h-[450px] space-y-0">
              {/* Header */}
              ...
              <div className="flex-1 p-5 overflow-y-auto space-y-3 bg-[#FFFAF3]/10">
                ...
                {peerTyping && (
                  <div className="flex justify-start">
                    <div className="bg-[#FFFAF3] border border-[#FFE5BF] rounded-xl rounded-tl-none px-3 py-2 flex items-center space-x-1">
              ...
              {/* Input Area */}
              <form onSubmit={handleSendChatMessage} className="p-3 bg-[#FFFAF3]/40 border-t border-[#FFE5BF] flex items-center space-x-2">
          ...
          {user && user.role === 'helper' && (
            <div className="glass p-6 rounded-3xl border border-[#FFE5BF] space-y-4">
              ...
              {isTaskLocked && !isAcceptedHelper ? (
                ...
                <div className="p-5 rounded-2xl bg-rose-100/15 border border-rose-300/30 space-y-4 text-center">
                  <div className="w-12 h-12 mx-auto rounded-full bg-rose-100/40 border border-rose-800/40 flex items-center justify-center">
                  ...
                  <div className="pt-3 border-t border-[#FFE5BF] space-y-2">
                    ...
                    {myBid.status === 'pending' && (
                      <button 
                        ...
                        className="w-full py-2.5 rounded-xl bg-rose-100/30 hover:bg-rose-900/40 border border-rose-300/50 text-rose-400 hover:text-rose-600 font-bold text-xs flex items-center justify-center space-x-1.5 transition"
                      >
                        <XCircle size={13} />
