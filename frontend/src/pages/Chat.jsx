...
export default function Chat() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 h-[calc(100vh-140px)] py-2 items-stretch">
      ...
      <div className="lg:col-span-3 glass rounded-3xl border border-[#FFE5BF] flex flex-col justify-between overflow-hidden">
        ...
        <div className="flex-1 p-6 overflow-y-auto space-y-4 bg-[#FFFAF3]/10">
              ...
              return (
                <div key={msg.id} className={`flex ${isMe ? 'justify-end' : 'justify-start'}`}>
                  <div className={`max-w-[70%] rounded-2xl p-3.5 space-y-1 ${isMe ? 'bg-[#FFE5BF] text-black rounded-tr-none' : 'bg-[#FFFAF3] border border-[#FFE5BF] text-black rounded-tl-none'}`}>
                    ...
                    {/* Time & Read Receipts */}
                    <div className="flex items-center justify-end space-x-1 text-[9px] text-black/70 pt-1">
                      <span>
          ...
          {peerTyping && (
            <div className="flex justify-start">
              <div className="bg-[#FFFAF3] border border-[#FFE5BF] rounded-2xl rounded-tl-none px-4 py-2.5 flex items-center space-x-1">
        ...
        {/* Input box */}
        <form onSubmit={handleSendMessage} className="p-4 bg-[#FFFAF3]/40 border-t border-[#FFE5BF] flex items-center space-x-3">
