  ...
  return (
    <div className="max-w-4xl mx-auto py-4 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        {/* Left Side: Forms */}
        <form onSubmit={handleSubmit} className="lg:col-span-2 glass p-6 md:p-8 rounded-3xl border border-[#FFE5BF] space-y-6">
          {error && (
            <div className="p-3.5 rounded-xl bg-rose-100/20 border border-rose-300/50 flex items-start space-x-2 text-rose-600 text-xs">
        ...
        <div className="glass p-6 rounded-3xl border border-[#FFE5BF] space-y-6">
          ...
          {scamAlert ? (
            <div className="p-4 rounded-2xl bg-rose-100/20 border border-rose-300/50 space-y-2">
              <div className="flex items-center space-x-2 text-rose-400 text-xs font-bold uppercase tracking-wider">
                <AlertTriangle size={15} />
                <span>Security Alert</span>
              </div>
              <p className="text-[11px] text-rose-600 leading-normal font-medium">{scamAlert}</p>
            </div>
          ) : (
            title && description && (
