        ...
        {(authMode === 'login' || authMode === 'register') && (
          <div className="space-y-4 pt-1">
            <button
              ...
              className="w-full py-3 px-4 rounded-xl bg-[#FFFAF3] hover:bg-[#FFF2DB] border border-[#FFE5BF] text-black text-xs font-bold flex items-center justify-center space-x-2.5 transition shadow-sm hover-scale disabled:opacity-50"
            >
